        ...
        >
          ...
          <div className="w-full lg:w-7/12 p-8 lg:p-12 flex flex-col justify-between bg-white">
            <div>
              ...
              {/* Default Administrator Credentials Helper */}
              <div className="mt-4 pt-3 border-t border-slate-100 flex flex-col gap-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="px-2.5 py-1 text-[11px] font-semibold bg-blue-50 text-blue-800 hover:bg-blue-100 rounded-lg border border-blue-200/80 transition-colors flex items-center gap-1.5 cursor-pointer"
                  >
                    <User className="w-3 h-3 text-blue-600" />
                    <span>System Admin: <strong className="font-mono font-bold">admin</strong> / <strong className="font-mono font-bold">password123</strong></span>
                  </button>
                  <button
                    type="button"
                    id="fill-dietary-admin-creds-btn"
                    onClick={() => {
                      setUsername("dietary_admin");
                      setPassword("password123");
                      setError(null);
                    }}
                    className="px-2.5 py-1 text-[11px] font-semibold bg-emerald-50 text-emerald-800 hover:bg-emerald-100 rounded-lg border border-emerald-200/80 transition-colors flex items-center gap-1.5 cursor-pointer"
                  >
                    <User className="w-3 h-3 text-emerald-600" />
                    <span>Dietary Admin: <strong className="font-mono font-bold">dietary_admin</strong> / <strong className="font-mono font-bold">password123</strong></span>
                  </button>
                </div>
              </div>
            </div>
